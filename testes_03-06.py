...
#Biblioteca para retornar um numero inteiro aleatório
from random import randint as rd
sorteado = rd(-100, 100)  # sorteia um número de -100 a 100
#print(sorteado)

#Criando uma lista de números inteiros maleatórios
...
#Outres maneira de fatiamento (omissão de start ou do end)
#my_list =["A", "B", "C", "D", "E", "F"]
#print(my_list)
#new_list = my_list[:3]
#print(new_list)
